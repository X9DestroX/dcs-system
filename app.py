...
BROKER = os.getenv(
    "MQTT_SERVER",
    "539babfa710d4b04b3dd26f984194029.s1.eu.hivemq.cloud"
)
    ...
    if attack:
        ...
        logs = [
            ...
            if any(
                ...
                attack in alert.lower()

                for alert in log.get(
                    "alerts",
                    []
                )
            )
